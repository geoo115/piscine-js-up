...
// Sample data object
const data = {
    luke: { isForceUser: true, pilotingScore: 90, shootingScore: 85 },
    leia: { isForceUser: false, pilotingScore: 75, shootingScore: 95 },
    han: { isForceUser: false, pilotingScore: 80, shootingScore: 75 },
    yoda: { isForceUser: true, pilotingScore: 95, shootingScore: 90 }
};

// Using the functions
const filteredForceUsers = filterForce(data);
console.log("Filtered Force Users:", filteredForceUsers);

const reducedScore = reduceScore(data, 100);
console.log("Reduced Score:", reducedScore);

const mappedAverage = mapAverage(data);
console.log("Mapped Average:", mappedAverage);
